  ...
  return (
    <section className="host__van van-host">
      <div className="van-host__container">
        <Link to="/host/vans" className="van-host__back-button">
          Back to all vans
        </Link>
        {vanData ? (
          <div className="van-host__body">
            <div className="van-host__header">
							...
							<img src={vanData.imageUrl} alt="Van" className="van-host__image" />
							</div>
							<div className="van-host__info">
							<div className={`van-host__type van-host__type_${vanData.type}`}>
                <p>
